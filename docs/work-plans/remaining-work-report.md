...
| E. 중우선도 누락 템플릿 작성 | 7개 개념 | **미완** |
| F. 저우선도 누락 템플릿 작성 | 3개 개념 | **미완** |
| G. DB 시드 실행 | PostgreSQL/Docker 기동 후 실행 | **대기** |
| H. 프론트→백엔드 파이프라인 | 문제 생성 → questions 테이블 저장 | **미완** |
...
| 학년 | 현재 | 목표 | 남은 수 |
|------|------|------|---------|
| 초4 (E4) | 17/23 (74%) | 23/23 | 6 |
| 초5 (E5) | 22/24 (92%) | 24/24 | 2 |
| 초6 (E6) | 14/16 (88%) | 16/16 | 2 |
| 중1 (M1) | 11/11 (100%) | - | 0 |
| 중2 (M2) | 9/9 (100%) | - | 0 |
| 중3 (M3) | 10/10 (100%) | - | 0 |
