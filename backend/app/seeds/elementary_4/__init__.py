...
def _get_tests():
    ...
    return [
        ...
        test(
            ...
            question_ids=[
                "e4-1-1-1-lv02-co-001", "e4-1-1-1-lv04-co-001", "e4-1-1-2-lv06-co-001",
                "e4-1-3-1-lv03-co-001", "e4-1-3-2-lv05-co-001", "e4-1-3-2-lv08-co-001",
                "e4-2-1-1-lv02-co-001", "e4-2-1-1-lv05-co-001", "e4-2-1-2-lv08-co-001",
                "e4-2-3-2-lv02-co-001", "e4-2-3-1-lv05-co-001", "e4-2-3-2-lv07-co-001",
            ],
        ...
        test(
            ...
            question_ids=[
                "e4-1-2-1-lv01-cc-001", "e4-1-2-1-lv04-cc-001", "e4-1-2-2-lv07-cc-001",
                "e4-1-4-1-lv02-cc-001", "e4-1-4-2-lv05-cc-001", "e4-1-4-2-lv07-cc-001",
                "e4-2-2-1-lv03-cc-001", "e4-2-2-2-lv06-cc-001", "e4-2-2-1-lv08-cc-001",
                "e4-2-4-1-lv02-cc-001", "e4-2-4-2-lv06-cc-001", "e4-2-4-2-lv09-cc-001",
                "e4-2-6-1-lv02-cc-001", "e4-2-6-2-lv06-cc-001", "e4-2-6-2-lv09-cc-001",
            ],
        ...
        test(
            ...
            question_ids=[
                "e4-1-5-1-lv02-cc-001", "e4-1-5-2-lv05-cc-001", "e4-1-5-1-lv07-cc-001",
                "e4-1-6-1-lv01-cc-001", "e4-1-6-1-lv05-cc-001", "e4-1-6-2-lv08-cc-001",
                "e4-2-5-1-lv03-cc-001", "e4-2-5-1-lv05-cc-001", "e4-2-5-2-lv07-cc-001",
            ],
        ...
        test(
            ...
            question_ids=[
                # 연산 (각 단원 1문항)
                "e4-1-1-1-lv02-co-001", "e4-1-3-2-lv05-co-001", "e4-2-1-1-lv05-co-001", "e4-2-3-1-lv05-co-001",
                # 개념 (각 단원 1문항)
                "e4-1-2-1-lv04-cc-001", "e4-1-4-2-lv05-cc-001", "e4-1-5-2-lv05-cc-001", "e4-1-6-1-lv05-cc-001",
                "e4-2-2-2-lv06-cc-001", "e4-2-4-2-lv06-cc-001", "e4-2-5-1-lv05-cc-001", "e4-2-6-2-lv06-cc-001",
                # 빈칸채우기 (3문항)
                "e4-1-3-1-lv02-fb-001", "e4-2-1-1-lv03-fb-001", "e4-2-3-2-lv03-fb-001",
            ],
