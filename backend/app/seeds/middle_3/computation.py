...
def get_computation_data() -> dict:
    ...
    # ============================================================
    # 문제: 실수와 그 연산 (15문제, 각 개념당 5개)
    # ============================================================
    real_questions = [
        # concept-m3-sqrt-01: 제곱근의 정의와 성질 (5개)
        mc(
            id="m3-1-1-1-lv01-co-001",
        ...
        mc(
            id="m3-1-1-1-lv03-co-001",
            concept_id="concept-m3-sqrt-01",
            category="computation",
            part="calc",
            difficulty=3,
            content="49의 양의 제곱근을 구하시오.",
            options=["7", "±7", "-7", "49"],
            correct="A",
            explanation="49의 양의 제곱근은 √49 = 7입니다.",
            points=10,
        ),
        mc(
            id="m3-1-1-1-lv04-co-001",
            concept_id="concept-m3-sqrt-01",
            category="computation",
            part="calc",
            difficulty=4,
            content="√100 + √(-10)²을 계산하시오.",
            options=["20", "10", "0", "100"],
            correct="A",
            explanation="√100 = 10, √(-10)² = |-10| = 10이므로 10 + 10 = 20",
            points=10,
        ),
        mc(
            id="m3-1-1-1-lv05-co-001",
            concept_id="concept-m3-sqrt-01",
            category="computation",
            part="calc",
            difficulty=5,
            content="x < 0일 때, √(x²)을 간단히 하면?",
            options=["-x", "x", "±x", "|x|"],
            correct="A",
            explanation="√(x²) = |x|이고, x < 0이므로 |x| = -x입니다.",
            points=10,
        ),
        # concept-m3-sqrt-02: 무리수와 실수의 분류 (5개)
        mc(
            id="m3-1-1-2-lv03-co-001",
            concept_id="concept-m3-sqrt-02",
            category="computation",
            part="calc",
            difficulty=3,
            content="√9는 유리수인가 무리수인가?",
            options=["유리수", "무리수", "정수가 아니다", "판별 불가"],
            correct="A",
            explanation="√9 = 3이므로 정수이며, 따라서 유리수입니다.",
            points=10,
        ),
        mc(
            id="m3-1-1-2-lv04-co-001",
            concept_id="concept-m3-sqrt-02",
            category="computation",
            part="calc",
            difficulty=4,
            content="√7은 유리수인가 무리수인가?",
            options=["무리수", "유리수", "정수", "순환소수"],
            correct="A",
            explanation="7은 완전제곱수가 아니므로 √7은 순환하지 않는 무한소수, 즉 무리수입니다.",
            points=10,
        ),
        mc(
            id="m3-1-1-2-lv05-co-001",
            concept_id="concept-m3-sqrt-02",
            category="computation",
            part="calc",
            difficulty=5,
            content="다음 중 무리수인 것은?",
            options=["√11", "√16", "√0.25", "√(1/9)"],
            correct="A",
            explanation="√16=4, √0.25=0.5, √(1/9)=1/3은 모두 유리수이고, √11만 무리수입니다.",
            points=10,
        ),
        mc(
            id="m3-1-1-2-lv06-co-001",
            concept_id="concept-m3-sqrt-02",
            category="computation",
            part="calc",
            difficulty=6,
            content="√2와 √3 사이에 있는 자연수를 모두 구하시오.",
            options=["없다", "2", "1", "2, 3"],
            correct="A",
            explanation="√2 ≈ 1.414, √3 ≈ 1.732이므로 그 사이에는 자연수가 없습니다.",
            points=10,
        ),
        mc(
            id="m3-1-1-2-lv07-co-001",
            concept_id="concept-m3-sqrt-02",
            category="computation",
            part="calc",
            difficulty=7,
            content="√5와 √10 사이에 있는 정수의 개수는?",
            options=["1개", "2개", "3개", "없다"],
            correct="A",
            explanation="√5 ≈ 2.236, √10 ≈ 3.162이므로 그 사이에는 정수 3이 하나 있습니다.",
            points=10,
        ),
        # concept-m3-sqrt-03: 근호 계산 (5개) - 기존 4개 + 1개 추가
        mc(
            id="m3-1-1-3-lv04-co-001",
        ...
        mc(
            id="m3-1-1-3-lv06-co-001",
            concept_id="concept-m3-sqrt-03",
            category="computation",
            part="calc",
            difficulty=6,
            content="√18 + √8을 간단히 하시오.",
            options=["5√2", "3√2", "√26", "2√13"],
            correct="A",
            explanation="√18 = 3√2, √8 = 2√2이므로 3√2 + 2√2 = 5√2",
            points=10,
        ),
    ]

    # ============================================================
    # 문제: 다항식의 곱셈과 인수분해 (15문제, 각 개념당 5개)
    # ============================================================
    factor_questions = [
        # concept-m3-factor-01: 곱셈 공식 (5개) - 기존 2개 + 3개 추가
        mc(
            id="m3-1-2-1-lv02-co-001",
        ...
        mc(
            id="m3-1-2-1-lv04-co-001",
            concept_id="concept-m3-factor-01",
            category="computation",
            part="algebra",
            difficulty=4,
            content="(x - 4)²을 전개하시오.",
            options=["x² - 8x + 16", "x² - 16", "x² + 8x + 16", "x² - 4x + 16"],
            correct="A",
            explanation="(x - 4)² = x² - 2·x·4 + 4² = x² - 8x + 16",
            points=10,
        ),
        mc(
            id="m3-1-2-1-lv05-co-001",
            concept_id="concept-m3-factor-01",
            category="computation",
            part="algebra",
            difficulty=5,
            content="(2x + 1)²을 전개하시오.",
            options=["4x² + 4x + 1", "4x² + 1", "2x² + 4x + 1", "4x² + 2x + 1"],
            correct="A",
            explanation="(2x + 1)² = (2x)² + 2·(2x)·1 + 1² = 4x² + 4x + 1",
            points=10,
        ),
        mc(
            id="m3-1-2-1-lv06-co-001",
            concept_id="concept-m3-factor-01",
            category="computation",
            part="algebra",
            difficulty=6,
            content="(3x + 2)(3x - 2)를 전개하면?",
            options=["9x² - 4", "9x² + 4", "9x² - 12x + 4", "3x² - 4"],
            correct="A",
            explanation="합차 공식: (3x + 2)(3x - 2) = (3x)² - 2² = 9x² - 4",
            points=10,
        ),
        # concept-m3-factor-02: 인수분해 기본 (5개) - 기존 4개 + 1개 추가
        mc(
            id="m3-1-2-2-lv04-co-001",
        ...
        mc(
            id="m3-1-2-2-lv07-co-001",
            concept_id="concept-m3-factor-02",
            category="computation",
            part="algebra",
            difficulty=7,
            content="x² + 7x + 12를 인수분해하시오.",
            options=["(x + 3)(x + 4)", "(x + 2)(x + 6)", "(x + 1)(x + 12)", "(x - 3)(x - 4)"],
            correct="A",
            explanation="합이 7이고 곱이 12인 두 수: 3과 4. 따라서 (x + 3)(x + 4)",
            points=10,
        ),
        # concept-m3-factor-03: 인수분해 심화 (5개) - 기존 2개 + 3개 추가
        mc(
            id="m3-1-2-3-lv07-co-001",
        ...
        mc(
            id="m3-1-2-3-lv06-co-001",
            concept_id="concept-m3-factor-03",
            category="computation",
            part="algebra",
            difficulty=6,
            content="x² - 8x + □가 완전제곱식이 되려면 □에 알맞은 수는?",
            options=["16", "64", "8", "4"],
            correct="A",
            explanation="완전제곱식 조건: □ = (8/2)² = 4² = 16. 즉, x² - 8x + 16 = (x - 4)²",
            points=10,
        ),
        mc(
            id="m3-1-2-3-lv08-co-001",
            concept_id="concept-m3-factor-03",
            category="computation",
            part="algebra",
            difficulty=8,
            content="9x² - 4를 인수분해하시오.",
            options=["(3x + 2)(3x - 2)", "(9x + 4)(x - 1)", "(3x - 2)²", "(9x - 2)(x + 2)"],
            correct="A",
            explanation="9x² - 4 = (3x)² - 2² = (3x + 2)(3x - 2) (합차 공식)",
            points=10,
        ),
        mc(
            id="m3-1-2-3-lv09-co-002",
            concept_id="concept-m3-factor-03",
            category="computation",
            part="algebra",
            difficulty=9,
            content="4x² + 12x + 9를 인수분해하시오.",
            options=["(2x + 3)²", "(4x + 3)(x + 3)", "(2x - 3)²", "(4x + 9)(x + 1)"],
            correct="A",
            explanation="4x² + 12x + 9 = (2x)² + 2·(2x)·3 + 3² = (2x + 3)²",
            points=10,
        ),
