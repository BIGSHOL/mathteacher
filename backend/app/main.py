        ...
        if not db.query(User).first():
            ...
            _chapter_defs = {
                ...
                "e3": ("elementary_3", [
                    ...
                    ("10. 들이와 무게", "L와 mL, kg과 g, 들이와 무게의 덧셈과 뺄셈", [], 2),
                    ("11. 분수 (2)", "단위분수, 진분수, 가분수, 대분수, 분수의 크기 비교", [], 2),
                ...
                "m1": ("middle_1", [
                    ...
                    ("4. 일차방정식", "등식의 성질, 일차방정식의 풀이, 활용", ["M1-ALG-02"], 2),
                    ("5. 좌표평면과 그래프", "순서쌍, 좌표, 정비례와 반비례 그래프", ["M1-FUNC-01"], 2),
                ...
                "m2": ("middle_2", [
                    ...
                    ("4. 삼각형과 사각형의 성질", "이등변삼각형, 외심·내심, 평행사변형, 특수사각형", ["M2-GEO-01"], 2),
                    ("5. 도형의 닮음과 피타고라스 정리", "닮음 조건, 닮음비, 피타고라스 정리", ["M2-GEO-02"], 2),
                ...
                # --- 공통수학1 / 고1 1학기 (4단원) ---
                "h1": ("high_1", [
                    ("1. 다항식", "다항식 연산, 항등식, 나머지정리, 인수분해", ["H1-ALG-01", "H1-ALG-02", "H1-ALG-03", "H1-ALG-04", "H1-ALG-05"], 1),
                    ("2. 방정식과 부등식", "복소수, 이차방정식, 이차함수, 이차부등식", ["H1-ALG-06", "H1-ALG-07", "H1-ALG-08", "H1-ALG-09", "H1-ALG-10", "H1-ALG-11", "H1-ALG-12", "H1-ALG-13", "H1-ALG-14", "H1-ALG-15", "H1-ALG-16", "H1-ALG-17"], 1),
                    ("3. 경우의 수", "합·곱의 법칙, 순열, 조합", ["H1-STA-10", "H1-STA-08", "H1-STA-09", "H1-STA-11", "H1-STA-12"], 1),
                    ("4. 행렬", "행렬의 덧셈·뺄셈·실수배·곱셈 (2×2 한정)", ["H1-ALG-18", "H1-ALG-19", "H1-ALG-20", "H1-ALG-21", "H1-ALG-22", "H1-ALG-23"], 1),
                ]),
                # --- 공통수학2 / 고1 2학기 (3단원) - 개념 데이터 미구축 ---
                "h2": ("high_2", [
                    ("1. 도형의 방정식", "평면좌표, 직선·원의 방정식, 평행이동·대칭이동", [], 2),
                    ("2. 집합과 명제", "집합 연산, 명제와 조건, 절대부등식", ["H1-STA-01", "H1-STA-02", "H1-STA-03", "H1-STA-04", "H1-STA-05", "H1-STA-06", "H1-STA-07"], 2),
                    ("3. 함수", "합성함수, 역함수, 유리함수, 무리함수", [], 2),
                ]),
            }
